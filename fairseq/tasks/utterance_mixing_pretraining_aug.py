...
from fairseq.data import Dictionary, UtteranceMixingDataset_AUG
...
@register_task("utterance_mixing_pretraining_aug", dataclass=UtteranceMixingPretrainingConfig)
class UtteranceMixingPretrainingTask_AUG(FairseqTask):
    ...
    def __init__(
        ...
        logger.info(f"HubertPretrainingTask AUG with RIR+MUSAN+SPK Config {cfg}")
    ...
    def load_dataset(self, split: str, **kwargs) -> None:
        ...
        self.datasets[split] = UtteranceMixingDataset_AUG(
            manifest,
